...
/**
 * Email-based authentication tests class.
 *
 * @package    auth_email
 * @category   test
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class auth_email_testcase extends advanced_testcase {

    /** @var auth_plugin_email Keeps the authentication plugin. */
    ...
    protected function setUp() {
        ...
        $this->authplugin = new auth_plugin_email();
        set_config('expiration', '1', 'auth_email');
        set_config('expiration_warning', '2', 'auth_email');
        set_config('expirationtime', '30', 'auth_email');
        $this->authplugin->config = get_config(auth_plugin_email::COMPONENT_NAME);
    }
    ...
    public function test_user_update_password() {
        ...
        $this->assertGreaterThanOrEqual($expectedtime, get_user_preferences('auth_email_passwordupdatetime', 0, $user->id));
